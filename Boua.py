...
for file in weather_files:
    try:
        ...
        if all(col in df.columns for col in ["DATE", "Latitude", "Longitude"]):
            ...
            print(f"⛔ Structure invalide, ignoré : {file}")
...
# 3️⃣ Fertilisation — Nutriments NPK
...
# 5️⃣ Pesticides — usage total, par ha, par habitant
...
# 6️⃣ Engrais par produit — type et quantité
...
# 7️⃣ Rendement — cultures & superficie
