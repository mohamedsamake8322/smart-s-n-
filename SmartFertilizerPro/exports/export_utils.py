...
class ExportUtilities:
    ...
    def prepare_export_payload(farmer_name: str, crop_name: str, region: str, recommendations: list) -> dict:
        """
        Prépare un dictionnaire exportable à partir des données de fertilisation.
        """
        return {
            "farmer": farmer_name,
            "crop": crop_name,
            "region": region,
            "recommendations": [
                {"element": elem, "dose": dose, "unit": unit}
                for elem, dose, unit in recommendations
            ]
        }
