...
print(merged_yield_df[['Area', 'Item', 'Year', 'Value_area', 'Value_prod', 'Yield_t_ha']].head())
...
# 🧼 Nettoyage final
final_df = step3_df.dropna(subset=['Yield_t_ha'])  # garder les lignes avec rendement calculé
