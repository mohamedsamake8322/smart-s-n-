...
class DiseaseManager:
    ...
    def get_disease_info(self, disease_name):
        ...
        return self.diseases.get(disease_name, "🚨 Aucune information trouvée sur cette maladie.")
    ...
    def analyze_image(self, image_path):
        ...
        detected_disease = self.decode_prediction(prediction)  # 📌 Traduction du label IA
...
disease_manager.add_disease(
    ...
    ["Beauveria bassiana", "Edovum puttleri", "bifenthrin", "zeta-cypermethrin", "lambda-cyhalothrin", "permethrin", "deltamethrin", "cyfluthrin", "pyrethrins + neem oil", "imiclacloprid", "sulfur", "methomyl", "fenpropathrin"]
)
...
disease_manager.add_disease(
    "False Chinch Bug",
    ["Alfalfa", "Brassicas", "Cucurbits", "Corn", "Leafy Greens", "Potato", "Root Crops", "Solanaceae Crops", "Hemp"],
...
disease_manager.add_disease(
    "Flea Beetles",
    ["Brassicas", "Leafy Greens", "Solanaceae Crops", "Root Crops", "Cucurbits", "Potato"],
    ...
    ["lacewing larvae", "big-eyed bugs", "damsel bugs", "bifenthrin", "zeta-cypermethrin", "lambda-cyhalothrin", "permethrin", "deltamethrin", "cyfluthrin", "pyrethrins + neem oil"]
)
disease_manager.add_disease(
...
disease_manager.add_disease(
    ...
    ["Alfalfa", "Asparagus", "Bean", "Cabbage", "Cauliflower", "Cucumber", "Garlic", "Onion", "Potato", "Small Grains", "Tomato"],
...
disease_manager.add_disease(
    "Potato Leafhopper",
    ["Alfalfa", "Legumes", "Potato", "Solanaceae", "Weeds including pigweed and shepherd's purse"],
...
disease_manager.add_disease(
    ...
    ["Corn", "Cucurbits", "Hemp", "Legumes", "Onions", "Root crops", "Solanaceae crops", "Many weeds and ornamentals"],
    ...
    ["predatory mites", "lacewings", "ladybugs", "bifenthrin", "zeta-cypermethrin", "lambda-cyhalothrin", "permethrin", "deltamethrin", "cyfluthrin", "pyrethrins + neem oil"]
)
disease_manager.add_disease(
    ...
    ["Bt (Bacillus thuringiensis)", "spinosad", "pyrethrins", "chlorantraniliprole", "lacewings", "big-eyed bugs", "damsel bugs", "minute pirate bugs", "Trichogramma pretiosum"]
)
disease_manager.add_disease(
    "Tomato Russet Mite",
...
disease_manager.add_disease(
    ...
    ["Field-grown and greenhouse-grown hemp", "Ageratum", "Aster", "Beans", "Begonia", "Calendula", "Cucumber", "Grape", "Hibiscus", "Lantana", "Nicotiana", "Poinsettia", "Squash", "Tomato"],
    ...
    ["azadirachtin", "potassium laurate", "clarified hydrophobic extract of neem oil", "pyrethrins", "capsicum oleoresin extract", "Encarsia sp.", "bifenthrin", "zeta-cypermethrin", "lambda-cyhalothrin", "permethrin", "deltamethrin", "cyfluthrin", "pyrethrins + neem oil"]
)
disease_manager.add_disease(
...
disease_manager.add_disease(
    ...
    ["Bean", "Beet", "Cucurbits", "Pepper", "Spinach", "Tomato", "Several other wild and economic hosts"],
    ...
    ["Integrated pest management (IPM)", "Avoid chemical treatments due to BLH migration"]
)
disease_manager.add_disease(
    "Big Bud",
    ["Tomato", "Pepper"],
...
disease_manager.add_disease(
    "Damping-Off",
    ["Brassicas", "Corn", "Cucurbits", "Leafy Greens", "Legumes", "Onions and Garlic", "Potato", "Root Crops", "Solanaceae"],
...
disease_manager.add_disease(
    "Fusarium Wilt",
    ["Alfalfa", "Asparagus", "Brassicas", "Cucurbits", "Garlic", "Hemp", "Legumes", "Onions", "Potatoes", "Root Crops", "Solanaceae"],
...
disease_manager.add_disease(
    "Verticillium Wilt",
    ["Cucurbits", "Solanaceae Crops", "Potato", "Many crop, ornamental, and weed species"],
